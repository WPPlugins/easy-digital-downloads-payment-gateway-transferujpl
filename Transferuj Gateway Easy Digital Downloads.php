...
function transferuj_register_gateway($gateways) {
    global $edd_options;
    $gateways['transferuj'] = array('admin_label' => 'tpay', 'checkout_label' => $edd_options['transferuj_display_name']);
    return $gateways;
}
   ...
   <input type="hidden" id="channel"  name="kanal" value=" ">
            ...
            <script type="text/javascript">
                function ShowChannelsCombo()
                {
                 ...
                 jQuery.getScript("https://secure.tpay.com/channels-{$id}0.js", function () {
                    ShowChannelsCombo()
                });
            </script>
            ...
            <div id="termsCheckboxBox">
                <input type="checkbox" id="termsCheckbox" checked name="terms_t">
                    <a href="https://tpay.com/regulamin.pdf" target="blank">
                                Akceptuję warunki regulaminu korzystania z serwisu tpay.com
                    </a>
                </input> </br></br>
...
MY_MARKER;
    ...
    if ($view == 1) {
        if(is_numeric($id)){
        $channels_url = "https://secure.tpay.com/channels-" . $id . "0.js";
        ...
        if (!$payment) {
            ...
            echo '
				...
				<input type="hidden" name="kanal" value="' . $_POST['kanal'] . '" />
                                <input type="hidden" name="akceptuje_regulamin" value="' . $terms . '" /> 
...
// sprawdzenie stanu transakcji
        ...
        if ($status_transakcji == 'TRUE' && $blad == 'none') {
            ...
            edd_insert_payment_note($order, 'Zapłacono przez tpay.com: ' . $id_transakcji);
